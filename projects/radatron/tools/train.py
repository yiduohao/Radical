...
class RadatronTrainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name):
        ...
        evaluators = [RadatronEvaluator(dataset_name, cfg, False, output_folder, mode="straight"),
                      RadatronEvaluator(dataset_name, cfg, False, output_folder, mode="rot"),
                      RadatronEvaluator(dataset_name, cfg, False, output_folder, mode="incoming"),
                      RadatronEvaluator(dataset_name, cfg, False, output_folder, mode="all"),
                      ]
        #evaluators = [RotatedCOCOEvaluator(dataset_name, cfg, False, output_folder)]
        # return DatasetEvaluators(evaluators)
        return DatasetEvaluators(evaluators, ["straight", "rot", "incoming", "all"])
