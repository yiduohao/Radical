...
def get_default_optimizer_params(
    ...
    lr_factors: Optional[Dict[str, float]] = None,
) -> List[Dict[str, Any]]:
    """
    ...
    for module_name, module in model.named_modules():
        lr_factor_module = 1.0
        for lr_factor_name in lr_factors.keys():
            if lr_factor_name in module_name:
                lr_factor_module = lr_factors[lr_factor_name]
        for module_param_name, value in module.named_parameters(recurse=False):
            ...
            hyperparams["lr"] *= lr_factor_module

            hyperparams.update(overrides.get(module_param_name, {}))
            print(module_name, module_param_name, hyperparams)
